...
const FRIDGE_COPY = {
  ro: {
    ...
    note: "Frigotehnist la domiciliu în", noteArea: "București și împrejurimi",
  ...
  en: {
    ...
    note: "Fridge technician at your home in", noteArea: "Bucharest & nearby",
  ...
  const t = {
    ro: {
      ...
      hero: {
        ...
        sub: "Vă pot oferi servicii rapide de reparații frigidere, combine frigorifice și congelatoare la domiciliu, în București și împrejurimi, în calitate de frigotehnist independent autorizat și certificat AGFR, cu garanție de 12 luni.",
    ...
    en: {
      ...
      hero: {
        ...
        sub: "I offer fast home repairs for fridges, fridge-freezers and freezers in Bucharest and surrounding areas, as an independent AGFR-authorized and certified refrigeration technician, with a 12-month warranty.",
